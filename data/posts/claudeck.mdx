...
The best part? You can **extend Claudeck using Claude Code itself**. I published a [Claude Code skill](https://github.com/hamed-farag/claudeck-skills) that lets you scaffold new plugins with a single command:

```bash
# Install the skill (one-time)
npx skills add https://github.com/hamed-farag/claudeck-skills
...
The source is on GitHub: [github.com/hamed-farag/claudeck](https://github.com/hamed-farag/claudeck)
